...
class UploadForm extends React.Component {
    ...
    let response = axios.post("http://127.0.0.1:5000/test", formData).then(response => this.setState({original: response.data.original, modified: response.data.modified, fileUpload: false})).catch(error => console.log("error happened in post calls"))
